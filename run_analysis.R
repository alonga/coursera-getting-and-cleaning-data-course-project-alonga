...
## Step 1: Clear the workspace to prevent unrelated "garbge"
rm(list=ls())

## Step 2: Setting paths and Reading raw data

raw.dataset.dir <-'raw/UCI HAR Dataset' ## 'raw/UCI HAR Dataset'
tidy.data.dir <- 'tidy'
